...
const REACT_APP_SPOT_SEARCH_KEYWORD_API_ENCODING =
  process.env.REACT_APP_SPOT_SEARCH_KEYWORD_API_ENCODING;
const REACT_APP_SPOT_SEARCH_KEYWORD_API_DECODING =
  process.env.REACT_APP_SPOT_SEARCH_KEYWORD_API_DECODING;
const REACT_APP_SPOT_SEARCH_AREA_API_ENCODING =
  process.env.REACT_APP_SPOT_SEARCH_AREA_API_ENCODING;
const REACT_APP_SPOT_SEARCH_AREA_API_DECODING =
  process.env.REACT_APP_SPOT_SEARCH_AREA_API_DECODING;
const REACT_APP_SPOT_AREACODE_API_ENCODING =
  process.env.REACT_APP_SPOT_AREACODE_API_ENCODING;
const REACT_APP_SPOT_AREACODE_API_DECODING =
  process.env.REACT_APP_SPOT_AREACODE_API_DECODING;
const REACT_APP_SPOT_CATEGORY_API_ENCODING =
  process.env.REACT_APP_SPOT_CATEGORY_API_ENCODING;
const REACT_APP_SPOT_CATEGORY_API_DECODING =
  process.env.REACT_APP_SPOT_CATEGORY_API_DECODING;
...
export const spotApi = {
  searchKeywordOrArea: async ({
    ...
    if (keyword_) {
      ...
      const response = await tourApiClient.get(
        `${REACT_APP_SPOT_SEARCH_KEYWORD_API_ENCODING}${parameter}`
      );
    ...
    const response = await tourApiClient.get(
      `${REACT_APP_SPOT_SEARCH_AREA_API_ENCODING}${parameter}`
    );
    console.log(response);
    return response.data;
  },
  ...
  getArea: async (areaCode_) => {
    try {
      ...
      // 공공 API 호출
      const response = await tourApiClient.get(
        `${REACT_APP_SPOT_AREACODE_API_ENCODING}${parameter}`
      );
      console.log(response);
  ...
  getCategory: async (contentTypeId_, category1_, category2_, category3_) => {
    ...
    const response = await tourApiClient.get(
      `${REACT_APP_SPOT_CATEGORY_API_ENCODING}${parameter}`
    );
    console.log(response);
    return response.data;
  },
